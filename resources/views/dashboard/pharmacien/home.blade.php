        ...
        <header id="header" class="header " >
          <div class="top-left" >
              <div class="navbar-header ">
                  <a class="navbar-brand" style="color:#41cba9; font-weight: bold;"   href="./">HOSPITAL PHARMACY</a>
...
.content {
  float: left;
  background-color: #86f3d8;
  padding: 1.875em;
  height:90vh ;
  width: 100%; }
             </style>
            @include('dashboard.backend_pharmacien.partials.allamount')
