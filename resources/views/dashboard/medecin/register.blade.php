...
<div class="signup-form">
    <form action="{{ route('medecin.create') }} " method="post" class="form-horizontal">
    ...
    <div class="form-group">
      ...
      <div class="col-xs-8">
          ...
          <div class="form-group">
            <label class="control-label col-xs-4">departement </label>
            <div class="col-xs-8">
              <select name="departement" class= "form-control">
                  <option value="">--Choisir un departemenet--</option>
             ...
             <div class="form-group">
              <label class="control-label col-xs-4">telephone </label>
              <div class="col-xs-8">
  ...
  <div class="text-center">Vous avez un compte ? <a href="{{ route('medecin.login') }}">Connectez-vous </a></div>
</div>
