                ...
                <div class="stat-widget-five">
                    ...
                    <div class="stat-content">
                        <div class="text-left dib">
                            <div class="stat-text"><span class="count">{{ DB::table('patients')->count()}}</span></div>
                            <div class="stat-heading">Nombre de patients </div>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="card" style=" box-shadow: 0px 10px 20px rgba(0, 0, 0, 0.5);height: 120px">
            <div class="card-body">
                <div class="stat-widget-five">
                    ...
                    <div class="stat-content">
                        <div class="text-left dib">
                            <div class="stat-text"><span class="count">{{ DB::table('ordonnances')->count()}}</span></div>
                            <div class="stat-heading">Nombre des Ordonnance</div>
                        </div>
                    </div>
                </div>
            </div>
...
<h1 style="text-align:center; color:#fff;  font-weight: bold; text-shadow: 0px 10px 10px rgba(0, 0, 0, 2);"> Bienvenu dans espace medecin<h1>
