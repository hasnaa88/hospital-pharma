...
<div class="signup-form">
    <form action="{{ route('fournisseur.create') }}" method="post" class="form-horizontal">
  ...
  <div class="text-center">Vous avez un compte ? <a href="{{ route('fournisseur.login') }}">Connectez-vous </a></div>
</div>
